...
//   Deselect the seat
  ...
  const handleConfirmStake = async () => {
    ...
    try {
      ...
      console.log("Haciendo Stake de", minStake, "CHZ para el asiento", selectedSeat.labels.own);
            ...
            <div className="p-6 space-y-6">
              <div className="flex items-center gap-4 bg-slate-800/50 p-4 rounded-xl border border-slate-700">
                ...
                <div className="ml-auto text-right">
                  <p className="text-sm text-gray-400">Valor Entrada</p>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-300">Stake Requerido:</span>
                ...
                <p className="text-xs text-gray-500">
                  * Estos tokens se bloquearán temporalmente para asegurar tu reserva.
                </p>
              </div>
